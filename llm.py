...
class PetNutritionLLM:
    def __init__(self, model_name: str = "mistral:7b"):
        ...
        self.closing_instructions: str = (
            ...
            "{{\n"
            '  "caloricIntake": "REQUIRED: daily calories with unit, e.g. 1000 kcal always number of calories first, then kcal",\n'
            '  "mealPlan": {{\n'
            ...
            '  "ingredients": [\n'
            '    {{\n'
            '      "recipeName": "REQUIRED: simple descriptive name for first recipe",\n'
            ...
            '    }},\n'
            '    {{\n'
            '      "recipeName": "REQUIRED: simple descriptive name for second recipe",\n'
            '      "ingredients": ["REQUIRED: only whole food ingredients"],\n'
            '      "preparation": ["REQUIRED: simple cooking instructions"],\n'
            '      "description": "REQUIRED: Write at least 2 complete sentences and no more than 4 sentences describing the recipe. Each recipe description MUST be at least 2 full sentences."\n'
            '    }}\n'
            ...
            '      "portionControl": "REQUIRED: specific guidelines",\n'
            '      "waterIntake": "REQUIRED: specific amounts",\n'
            '      "feedingTips": "REQUIRED: practical advice"\n'
            '  }},\n'
            '  "supplements": "REQUIRED: specific supplements or No supplements required",\n'
            '  "foodsToAvoid": "REQUIRED: specific foods or Standard cautions",\n'
            '  "transitionGuidelines": "REQUIRED: specific transition plan"\n'
            "}} [/INST]\n"
        )
